...
<header class="header_area">
			<div class="main_menu">
				<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<a class="navbar-brand logo_h" href="index.html"><img src="public/visitor/img/logo.png" alt=""></a>
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							...
							<ul class="nav navbar-nav navbar-right header_social ml-auto">
								...
								<li class="nav-item">
								  <a class="nav-item " href="user/login"><i class="fa fa-user" aria-hidden="true"></i>LOGIN</a>
								</li>
							</ul>
						</div> 
					</div>
			...
			<div class="logo_part">
				<div class="container">
					<a class="logo" href="#"><img src="public/visitor/img/logo.png" alt=""></a>
				</div>
			</div> 
        </header>
        <!--================Header Menu Area =================-->
