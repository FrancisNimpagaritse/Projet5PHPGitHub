                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">                        
                        <aside class="single_sidebar_widget author_widget text-center">
                            <img class="author_img img-fluid rounded center-block" src="<?=$_ENV['URL_PATH']?>views/admin/myImage/francis-01.png" style="width:310px; height:320px;" alt="">
                            ...
                            <div class="blog_text p-1 text-center">
                                <div class="blog_text_inner ">
                                    <div class="cat p-1">
                                        ...
                                        <a class="blog_btn mt-2 pb-0" href="<?=$_ENV['URL_PATH']?>views/admin/myImage/CV_François_Nimpagaritse.pdf" target="_blank">Voir mon CV</a>
                                    </div>
                                </div>
							</div>
                        </aside>                        
...
<section class="contact_area p_120">    
    <div class="row">
        ...
        <div class="col-lg-9">
            <form class="row contact_form" action="<?=$_ENV['URL_PATH']?>home/send" method="post" id="contactForm">
                <div class="col-md-6">
