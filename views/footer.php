                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <?php if(isset($_SESSION['user_id'])) : ?>
                            <a class="btn btn-primary" href="<?=Validator::escapingData($this->env['URL_PATH'])?>authentication/logout">Logout</a>
                        <?php else : ?>									
                            <a class="btn btn-primary" href="<?=Validator::escapingData($this->env['URL_PATH'])?>authentication/login">Login</a>								
                        <?php endif ; ?>                        
                    </div>	
