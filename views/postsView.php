                    ...
                    <div class="blog_text_slider owl-carousel">
                        <div class="item">
                            <div class="blog_text" style="border-radius:7px;">
                                ...
                                <p><?=$newPost->content;?></p>
                                <a class="blog_btn" href="<?=Validator::escapingData($this->env['URL_PATH'])?>posts/show/<?=$newPost->id;?>">Lire la suite</a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="blog_text">
                ...
                <div class="col-lg-8">
                    <div class="blog_left_sidebar">
                        ...
                        <article class="blog_style1">
                            <div class="blog_img">
                                <img class="img-fluid" src="<?=Validator::escapingData($this->env['URL_PATH'])?>public/visitor/img/blogposts/blog-Populaire.jpg" alt="">
                            </div>
                            <div class="blog_text">
                                ...
                                <div class="blog_text_inner">
                                    ...
                                    <a class="blog_btn" href="<?=Validator::escapingData($this->env['URL_PATH'])?>posts/show/<?=$popularOne->id;?>">Lire la suite</a>
                                </div>
                                    ...
                                    <article class="blog_style1 small">
                                        ...
                                        <div class="blog_text">
                                            <div class="blog_text_inner">
                                                ...
                                                <p><?=$post->content;?></p>
                                                <a class="blog_btn" href="<?=Validator::escapingData($this->env['URL_PATH'])?>posts/show/<?=$post->id;?>">Lire la suite</a>
                                            </div>
                                        </div>
                                    </article>
                                </div>
