...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?=Validator::escapingData($_ENV['URL_PATH'])?>user/register" method="post">
        ...
        <div class="row">
          <div class="col-8">            
            <a href="<?=Validator::escapingData($_ENV['URL_PATH'])?>authentication/login" class="btn btn-success">Déjà inscrit? Connexion
            </a>
          </div>
          <!-- /.col -->
          <div class="col-4">
