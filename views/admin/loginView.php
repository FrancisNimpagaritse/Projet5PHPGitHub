...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?=Validator::escapingData($_ENV['URL_PATH'])?>authentication/login" method="post">
        ...
        <div class="row">
          ...
          <div class="col">
            <p></p>
            <a href="<?=Validator::escapingData($_ENV['URL_PATH']);?>user/register" class="btn btn-danger btn-block">Pas inscrit? S'inscrire
            </a>
          </div>
        </div>
      </form>
      ...
      <div class="row">
        <div class="col-6">
          <a href="<?=Validator::escapingData($_ENV['URL_PATH']);?>authentication/forgotPassword" class="btn btn-light mt-2">Password oublié</a>
        </div>
        <div class="col-6">
