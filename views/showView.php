                ...
                <div class="row">
                    <div class="col-lg-8">
       					<div class="main_blog_details">
       						<img class="img-fluid" src="<?=Validator::escapingData($this->env['URL_PATH'])?>public/visitor/img/blog/news-blog.jpg" alt="">
       						...
       						<div class="user_details">
       							...
       							<div class="float-right">
       								<div class="media">
       									...
       									<div class="d-flex">
       										<img src="<?=Validator::escapingData($this->env['URL_PATH'])?>public/visitor/img/blog/user-img.jpg" alt="">
       									</div>
       								</div>
       							</div>
       						</div>
                                    ...
                                    foreach($comments as $comment): ?>
                                        <div class="single-comment justify-content-between d-flex">
                                            <div class="user justify-content-between d-flex">
                                                <div class="thumb">
                                                    <img src="<?=Validator::escapingData($this->env['URL_PATH'])?>public/visitor/img/blog/c1.jpg" alt="">
                                                </div>
                                                <div class="desc">
                        ...
                        <div class="comment-form">
                            ...
                            <form action="<?=Validator::escapingData($this->env['URL_PATH'])?>comment/add" method="POST">
                                ...
                                <?php } else { ?>                                    
                                    <a class="btn btn-dark" href="<?=Validator::escapingData($this->env['URL_PATH'])?>authentication/login">Connectez-vous pour commenter</a>
                                <?php } ?>
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget author_widget">
                                <img class="author_img img-fluid" src="<?=Validator::escapingData($this->env['URL_PATH'])?>public/visitor/img/blog/author.png" alt="">
